		...
		<%
			...
			try {
				...
				if (flag == 0) {
					...
					out.println(
							"<div id=\"about_text\"><b><br/><br/><h1><center><i>Thank you for subscribing to StopNrecharge.com. You will now receive all our updates via SMS/E-mails.</i></center></h1></b></div>");
				} else {
